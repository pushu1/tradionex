...
//                 setActiveFilter(cat);
//               }}
//               className={`px-4 py-2 text-sm font-medium rounded-full transition-colors ${activeFilter === cat
    ...
    <>
      <div className="mb-16">
        ...
        <p className="text-xl text-gray-600">
          A visual journey through our mining operations, processing
          facilities, and premium natural resources.
        </p>
      </div>
