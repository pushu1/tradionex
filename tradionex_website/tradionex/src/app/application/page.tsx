  ...
  const industries = [
    {
      ...
      icon: <Factory className="w-8 h-8 text-blue-600 mb-4" />
    },
    {
      ...
      icon: <Microscope className="w-8 h-8 text-blue-600 mb-4" />
    },
    {
    ...
    },
    {
      ...
      icon: <Building2 className="w-8 h-8 text-blue-600 mb-4" />
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50 py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">Industrial Applications</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {industries.map((industry, index) => (
            <div key={index} className="bg-white p-10 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
              ...
              <a href="#" className="inline-flex items-center text-sm font-semibold text-blue-600 group-hover:text-blue-700 transition-colors">
