    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen w-full flex items-end pb-12 md:pb-24 pt-32 overflow-hidden bg-gray-900">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1541888087519-9c5950117498?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <div className="flex flex-col md:flex-row justify-between items-end mb-10">
              ...
              <Link href="/application" className="hidden md:inline-flex items-center text-blue-600 font-semibold hover:text-blue-800 transition-colors">
    ...
    <h3 className="text-xl font-bold text-white mb-1 group-hover:text-blue-300 transition-colors">
      {item.name}
          ...
          <div>
            <div className="flex flex-col md:flex-row justify-between items-end mb-10">
              <div className="max-w-2xl">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4 tracking-tight">Export Products</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {productGlimpses.map((item) => (
                <Link key={item.slug} href={`/products/${item.slug}`} className="group block bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <div className="p-8">
                    <CheckCircle2 className="w-8 h-8 text-blue-600 mb-4 opacity-50 group-hover:opacity-100 transition-opacity" />
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3 group-hover:text-blue-600 transition-colors">{item.name}</h3>
                    <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">{item.desc}</p>
                    <span className="inline-flex items-center font-semibold text-gray-900 dark:text-gray-100 group-hover:text-blue-600 transition-colors">
      ...
      <section className="py-24 bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4 tracking-tight">The Tradionex Advantage</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="p-8 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-shadow">
              <Globe2 className="w-10 h-10 text-blue-600 dark:text-blue-400 mb-6" />
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Global Reach</h3>
            ...
            <div className="p-8 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-shadow">
              <ShieldCheck className="w-10 h-10 text-blue-600 dark:text-blue-400 mb-6" />
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Uncompromising Quality</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <div className="p-8 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-shadow">
              <Factory className="w-10 h-10 text-blue-600 dark:text-blue-400 mb-6" />
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">Scale & Capacity</h3>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
      ...
      <section className="py-24 bg-blue-900 dark:bg-blue-950 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Ready to secure your supply chain?</h2>
          ...
          <Link 
            href="/contact" 
            className="inline-flex px-8 py-4 bg-white text-blue-900 font-bold rounded-full hover:bg-gray-100 transition-colors shadow-xl"
          >
